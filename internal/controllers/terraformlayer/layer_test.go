...
var _ = Describe("TerraformLayerConditions", func() {
	...
	BeforeEach(func() {
		...
		Describe("IsPlanArtifactUpToDate", func() {
		...
		Describe("IsApplyUpToDate", func() {
			Context("without plan", func() {
				It("should return true", func() {
					_, condition := r.IsApplyUpToDate(t)
					Expect(condition).To(Equal(true))
				})
			})
		...
		Describe("HasFailed", func() {
			Context("without run result", func() {
				It("should return false", func() {
					_, condition := r.HasFailed(t)
					Expect(condition).To(Equal(false))
				})
			})
			...
			Context("with multiple failure", func() {
				It("should return true", func() {
					t.Annotations[annotations.Failure] = "2"
					_, condition := r.HasFailed(t)
					Expect(condition).To(Equal(true))
				})
			})
		...
		Describe("IsLastConcerningCommitPlanned", func() {
			Context("with all commits aligned", func() {
				It("should return true", func() {
					t.Annotations[annotations.LastBranchCommit] = "6097d33f898fb78d32383d2e09fa6ae9584092a4"
					t.Annotations[annotations.LastConcerningCommit] = "6097d33f898fb78d32383d2e09fa6ae9584092a4"
					t.Annotations[annotations.LastPlanCommit] = "6097d33f898fb78d32383d2e09fa6ae9584092a4"
					_, condition := r.IsLastConcerningCommitPlanned(t)
					Expect(condition).To(Equal(true))
				})
			})
			Context("with LastBranchCommit = LastConcerningCommit != LastPlanCommit", func() {
				It("should return false", func() {
					t.Annotations[annotations.LastBranchCommit] = "6097d33f898fb78d32383d2e09fa6ae9584092a4"
					t.Annotations[annotations.LastConcerningCommit] = "6097d33f898fb78d32383d2e09fa6ae9584092a4"
					t.Annotations[annotations.LastPlanCommit] = "d52b46786983d5492585590339d9f35bb64202eb"
					_, condition := r.HasFailed(t)
					Expect(condition).To(Equal(false))
				})
			})
			Context("with LastBranchCommit != LastConcerningCommit != LastPlanCommit", func() {
				It("should return true", func() {
					t.Annotations[annotations.LastBranchCommit] = "d52b46786983d5492585590339d9f35bb64202eb"
					t.Annotations[annotations.LastConcerningCommit] = "6097d33f898fb78d32383d2e09fa6ae9584092a4"
					t.Annotations[annotations.LastPlanCommit] = "d52b46786983d5492585590339d9f35bb64202eb"
					_, condition := r.HasFailed(t)
					Expect(condition).To(Equal(true))
...
var _ = Describe("TerraformLayerState", func() {
	var t *configv1alpha1.TerraformLayer
	var r *Reconciler
	BeforeEach(func() {
		t = &configv1alpha1.TerraformLayer{
