...
func GetPreventDestroyEnabled(repo *TerraformRepository, layer *TerraformLayer) bool {
	return chooseBool(repo.Spec.RemediationStrategy.PreventDestroy, layer.Spec.RemediationStrategy.PreventDestroy, false)
}
